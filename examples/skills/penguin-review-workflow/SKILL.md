...
3. Check the penguin checklist:
   - `description` is one non-empty line, and `penguin list workflows` shows the workflow with the params the design names.
   ...
   - Every skill name the file uses resolves in `penguin list skills`.
