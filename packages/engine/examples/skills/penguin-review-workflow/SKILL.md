...
3. Check the penguin checklist:
   ...
   - The params stay minimal: one required free-text subject, and every further param is one the run cannot start without, no agent turn can derive, and no gate can ask at the moment it matters. No param validates meaning with a pattern.
