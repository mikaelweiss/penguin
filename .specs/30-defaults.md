...
The engine ships empty. No agent, workflow, or skill is part of the core, and every entry below is removable (`20-architecture.md`, invariant 9). This file is the catalog of what a fresh install contains.
